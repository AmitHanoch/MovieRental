    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Loan", x => new { x.MovieId, x.CustomerId, x.LoanDate });
                    table.UniqueConstraint("AK_Loan_CustomerId_LoanDate_MovieId", x => new { x.CustomerId, x.LoanDate, x.MovieId });
                    table.ForeignKey(
